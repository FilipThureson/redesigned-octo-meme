<div id="header">
    ...
    <nav>
        <ul>
            ...
            <li class="navLinks" id="profile">
                <a href="/profile/{{Session::get('user')[0]->id}}">
                    <img class="pfp" src="{{ asset('img/' . Session::get('user')[0]->profile_pic) }}" alt="">
                </a>
            </li>
            <li>
                <form action="/api/logout" method="post">
                    @csrf
                    <button id="logutBtn" type="submit">
